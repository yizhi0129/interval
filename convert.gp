...
plot 'convert_time.txt' using (1):1 with points pt 6 ps 1.5 lc rgb '#42b983' title "CR 1", \
     ...
     '' using (5):5 with points pt 6 ps 1.5 lc rgb 'yellow' title "read radius", \
     ...
     '' using (5):(S5_median) with points pt 7 ps 1.5 lc rgb 'red' notitle, \
